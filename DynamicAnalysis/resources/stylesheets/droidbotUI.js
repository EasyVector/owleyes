...
function getNodeDetails(nodeId) {
  ...
  stateInfo = '<h2>State Details</h2><hr/><div class="row" style=\"height:70%;overflow: auto;display: flex;\">\n';
  stateInfo += "<div class=\"col-md-5\" style=\"height:100%;width: auto;\"><div style=\"height: 5%;text-align:center;\">Screenshot</div><img style=\"height:95%;\" src=\"" + selectedNode.image + "\"></div>"
  if(selectedNode.bug==true)
    stateInfo += "<div class=\"col-md-5\" style=\"height:100%;width: auto;\"><div style=\"height: 5%;text-align:center;\">Localization Result</div><img style=\"height:95%;\" title=\"Localization Result\" src=\"" + selectedNode.cam + "\"></div>"
  // stateInfo += "<div class=\"col-md-5\" style=\"height:100%;width: auto;\"><div style=\"height: 5%;text-align:center;\">gb Result</div><img style=\"height:95%;\" src=\"" + selectedNode.gb + "\"></div>"
  // stateInfo += "<div class=\"col-md-5\" style=\"height:100%;width: auto;\"><div style=\"height: 5%;text-align:center;\">gb_cam Result</div><img style=\"height:95%;\" src=\"" + selectedNode.gb_cam + "\"></div>"
  stateInfo += "</div><div class=\"col-md-7\">" + selectedNode.title + "</div>";
  return stateInfo;
}
