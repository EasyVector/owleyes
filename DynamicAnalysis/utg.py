    ...
    def __output_utg(self):
        ...
        for state_str in self.G.nodes():
            ...
            utg_node = {
                ...
                # "gb": os.path.relpath(state.gb_path, self.device.output_dir),
                # "gb_cam": os.path.relpath(state.gb_cam_path, self.device.output_dir),
                # "cam": os.path.relpath(state.cam_path, self.device.output_dir),
            ...
            if state.bug:
                utg_node['color'] = {"border": "red",
                                  "background": "red",
                                  "highlight": { "border": "red", "background": "red" },
                                  "hover": { "border": "red", "background": "red" },
                                  }
                utg_node['bug'] = True
            else:
                utg_node['color'] = {"border": "green",
                                     "background": "green",
                                     "highlight": {"border": "green", "background": "green"},
                                     "hover": {"border": "green", "background": "green"},
                                     }
                utg_node['bug'] = False
